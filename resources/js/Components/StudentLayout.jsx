...
export default function StudentLayout({ user, children, title }) {
    ...
    const studentNav = [
        { label: 'Dashboard', href: '/student/dashboard', icon: ChartBarIcon },
        { label: 'Courses', href: '/student/courses', icon: BookOpenIcon },
        { label: 'Scanner', href: '/student/scanner', icon: QrCodeIcon },
        { label: 'Attendance History', href: '/student/attendance-history', icon: ClipboardIcon },
    ];
            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
                ...
                <div className={`fixed left-0 top-16 w-72 h-screen bg-white border-r border-gray-100 overflow-y-auto transition-all duration-300 lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} shadow-lg lg:shadow-none`}>
                    <nav className="p-6 space-y-2">
                        {/* Brand/Logo section */}
                        <div className="mb-8">
                            <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-widest px-4">Student</h3>
                        </div>
                ...
                <div className="lg:ml-72 pt-6">
                    ...
                    {title && (
                        <div className="px-4 lg:px-8 mb-10">
                            ...
                            <p className="text-gray-500 text-sm mt-2">Track your attendance and courses</p>
                        </div>
                    )}
